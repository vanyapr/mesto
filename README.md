...
Проектная работа номер четыре в рамках Яндекс.Практикума. Цель проектной работы - научиться применять JavaScript для
...
Ветки сливаются через `git merge`в ветку `master`, которая публикуется в этом репозитории и отдается на код-ревью.

__Срок сдачи проекта - до 21 июня 2020 года__
