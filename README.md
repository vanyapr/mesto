...
**Проектная работа номер семь** в рамках Яндекс.Практикума. Цель проектной работы - научиться применять ООП (Объектно-ориентированое программирование) JavaScript для реализации интерактивных элементов на страницах сайта.
...
17. ~~Перевод валидации форм на Классы.~~
17. ~~Перевод генерации карточек мест на классы.~~
